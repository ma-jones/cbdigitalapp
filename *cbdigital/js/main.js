...
var tLeftButton = $("#journey-l");
var tRightButton = $("#journey-r");

// Get number of <li> elements in carousel

var tItemCount = document.getElementById('journey-ul').querySelectorAll('li').length;

// Set length based on that

var tWidth = tItemCount * 100 + "vw";
$(".journey ul").css("width", tWidth);
...
if ( tItemCount == 1 ) {
  $('.journey-control').css('display','none');
}
